        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <Card className="hover:border-black transition-colors hover:shadow-lg">
            <CardContent className="p-8">
              ...
              <h3 className="text-xl font-bold text-black mb-3">{t('home.discoverResources')}</h3>
          ...
          <Card className="hover:border-black transition-colors hover:shadow-lg">
            <CardContent className="p-8">
              ...
              <h3 className="text-xl font-bold text-black mb-3">{t('home.shareKnowledge')}</h3>
              <p className="text-gray-600 leading-relaxed">
          ...
          <Card className="hover:border-black transition-colors hover:shadow-lg">
            <CardContent className="p-8">
              ...
              <h3 className="text-xl font-bold text-black mb-3">{t('home.collaborate')}</h3>
              <p className="text-gray-600 leading-relaxed">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-white mb-2">{t('home.highQuality')}</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-white mb-2">{t('home.activeCommunity')}</h4>
                  <p className="text-gray-300">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-white mb-2">{t('home.easyToUse')}</h4>
                  <p className="text-gray-300">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-white mb-2">{t('home.freeAndOpen')}</h4>
                  <p className="text-gray-300">
