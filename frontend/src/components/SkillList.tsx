        ...
        <div className="flex items-start justify-between">
          <div className="flex-1 min-w-0">
            <div className="flex items-center space-x-3 mb-2">
              ...
              <Badge variant="default" className="text-xs bg-black">
                v{skill.version}
              </Badge>
            </div>
            ...
            <div className="flex items-center space-x-6 text-sm text-gray-500">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-medium">{skill.owner?.username || 'Unknown'}</span>
              </div>
              
              <div className="flex items-center space-x-1">
                <div className="flex">{renderStars(skill.averageRating)}</div>
                <span className="font-medium">({skill.ratingsCount})</span>
              </div>
